        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <PricingCarousel autoplayDelay={4000}>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-forest-green transition-colors h-full flex flex-col">
                ...
                <div className="text-center mb-6">
                  <div className="text-4xl font-bold" style={{ color: 'var(--forest-green)' }}>60€</div>
                  <div className="text-sm text-gray-500 mt-1">Jour (6h-22h)</div>
                </div>

                <div className="text-center mb-6 pb-6 border-b border-gray-200">
                  <div className="text-3xl font-bold text-gray-700">70€</div>
            ...
            <div className="bg-white border-2 rounded-2xl p-8 hover:border-forest-green transition-colors h-full flex flex-col" style={{ borderColor: 'var(--forest-green)' }}>
                ...
                <div className="text-center mb-6">
                  <div className="text-4xl font-bold" style={{ color: 'var(--forest-green)' }}>55€</div>
                  <div className="text-sm text-gray-500 mt-1">Jour (6h-22h)</div>
                </div>

                <div className="text-center mb-6 pb-6 border-b border-gray-200">
                  <div className="text-3xl font-bold text-gray-700">65€</div>
                  <div className="text-sm text-gray-500 mt-1">Nuit (22h-6h)</div>
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          <FadeInSection delay={0}>
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Transferts depuis ou vers les principales gares de Paris
              </p>
            </div>
          </FadeInSection>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <FadeInSection key={gare.name} delay={index * 0.05}>
                <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-all h-full">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="font-bold text-lg mb-1" style={{ color: 'var(--forest-green)' }}>{gare.name}</h3>
                      <p className="text-sm text-gray-600">Paris intra-muros</p>
                    </div>
                    <div className="text-2xl font-bold" style={{ color: 'var(--forest-green)' }}>{gare.price}</div>
                  </div>
                </div>
              </FadeInSection>
            ))}
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm text-gray-700">
                    <strong>Note :</strong> Ces tarifs s&apos;appliquent pour des trajets depuis/vers Paris intra-muros. 
                    Pour les destinations en banlieue, contactez-nous pour un devis personnalisé.
                  </p>
                </div>
              </div>
            </div>
          ...
          <PricingCarousel autoplayDelay={4000}>
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-forest-green transition-colors h-full flex flex-col">
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-gray-600">Flexibilité maximale</p>
                </div>
      ...
      <section className="py-16 px-4 sm:px-6" style={{ backgroundColor: '#FAFAF9' }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <FadeInSection delay={0}>
              <div className="bg-white p-6 rounded-xl text-center h-full flex flex-col">
