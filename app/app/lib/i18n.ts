...
> = {
  fr: {
    ...
    priceNotice: 'Prix indicatif TTC, selon les conditions de circulation',
  ...
  en: {
    ...
    priceNotice: 'Indicative fare incl. tax, depending on traffic conditions',
  ...
  es: {
    ...
    priceNotice: 'Precio indicativo con impuestos, según el tráfico',
