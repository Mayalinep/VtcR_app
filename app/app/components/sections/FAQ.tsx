...
import { FAQ_DATA_MULTILINGUAL } from '../../lib/data/faq';
import { getLocaleFromPath } from '../../lib/i18n';

export default function FAQ() {
  const locale = getLocaleFromPath(usePathname() || '/');
  const faqData = FAQ_DATA_MULTILINGUAL[locale];
      ...
      {faqData.map((item) => (
        ...
        >
          ...
          >
            ...
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: 'var(--forest-green)' }}>
